    ...
    <li className={`py-3 sm:py-4`}>
      <div className={`flex items-center space-x-4`}>
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-500 truncate dark:text-gray-400 md:inline md:mr-3">
            <strong>Price:</strong> {search.fromPrice || "n/a"} PLN -{" "}
            {search.toPrice || "n/a"} PLN;
          </p>
          <p className="text-sm text-gray-500 truncate dark:text-gray-400 md:inline">
        ...
        <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
          ...
          {!favSearchId && (
            <Link href={`searches/?users=${search.id}`}>
              <svg
                className="w-[30px] h-[30px] text-gray-800 dark:text-white rotate-180 hover:w-[40px] hover:hover:-translate-x-1 hover:transition hover:ease-in-out hover:text-green-500"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
